...
if ($attendance && $attendance['is_completed'] == 1) {
    header("Location: success_page.php?message=Attendance already completed!");
    exit();
}
...
if (!$registration || $registration['is_completed'] == 0) {
    die("Access Denied: Please complete the registration before accessing the attendance form.");
}
...
<body>
    <div class="container py-5">
        <div class="text-center mb-4">
            <h1 class="text-primary">Attendance Form</h1>
            <h3><?php echo $course_name; ?></h3>
        </div>

        <div class="form-container mx-auto">
            <div class="description-box">
                <p>Dear Participants, <br> Please fill out the attendance form below to confirm your participation in
                    this program.</p>
            </div>
