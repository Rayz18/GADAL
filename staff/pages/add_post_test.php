...
<div class="layout">
        ...
        <div id="content" class="content">
            ...
            <h1 class="page-title">MANAGE POST-TEST QUESTIONS</h1>
        ...
        <!-- Questions Table -->
        <div class="card">
            <div class="card-header">Post-Test Questions</div>
            <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" style="display:inline;">
                                            ...
                                            <input type="hidden" name="post_test_id"
                                                value="<?php echo $row['post_test_id']; ?>">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addQuestionModalLabel">Add Post-Test Question</h5>
