...
// Fetch all custom fields, including instructions
...
$instructions_stmt = $conn->prepare("SELECT instructions FROM seminars WHERE seminar_id = ? LIMIT 1");
$instructions_stmt->bind_param("i", $seminar_id);
$instructions_stmt->execute();
$instructions_result = $instructions_stmt->get_result();
$instructions = $instructions_result->fetch_assoc()['instructions'] ?? '';
...
<body class="bg-light py-5 d-flex justify-content-center">
    <div class="bg-white p-4 rounded shadow w-100" style="max-width: 800px;">
        ...
        <form id="registration-form" action="save_registration.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="instructions-textarea" name="instructions"
            ...
            <button type="submit" class="btn btn-update w-100" id="update-button">Update Registration</button>
        </form>
    </div>
