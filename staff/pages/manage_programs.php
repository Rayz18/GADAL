                ...
                while ($program = $programs_query->fetch_array()) { ?>
                    <div class="card mb-3 program-card">
                        ...
                        <div id="collapse-<?php echo $program['program_id']; ?>"
                            ...
                            aria-labelledby="heading-<?php echo $program['program_id']; ?>" data-parent="#programAccordion">
                            <div class="card-body">
                                <p class="program-desc"><?php echo nl2br(htmlspecialchars($program['program_desc'])); ?></p>
